...
export default function Overview() {
    ...
    const sortedFiles = (files ?? []).slice().sort((a, b) => b.functions - a.functions).slice(0, 10)
    ...
    return (
        <div className="fade-in">
            ...
            <div style={gridStyle}>
                ...
                <MetricCard label="Total Nodes" value={stats.nodes} />
                <MetricCard label="Total Edges" value={stats.edges} />
